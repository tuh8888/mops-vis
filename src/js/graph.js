...
class Graph {
    ...
    intersectionSearch() {
        ...
        const maxDepth = parseInt(document.getElementById("max-depth-text-field").value);
        const maxFanout = parseInt(document.getElementById("max-fanout-text-field").value);
